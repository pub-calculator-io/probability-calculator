...
Version: 1.0.0
Author: Probability Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Probability Calculator by www.calculator.io";

function display_calcio_ci_probability_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_probability_calculator', 'display_calcio_ci_probability_calculator' );